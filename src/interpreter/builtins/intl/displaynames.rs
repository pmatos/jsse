...
fn get_currency_display_name(code: &str, style: &str) -> Option<&'static str> {
    ...
    let name = match upper.as_str() {
        ...
        "BAM" => match style {
            "short" | "narrow" => "BAM",
            _ => "Bosnia-Herzegovina Convertible Mark",
        },
        "BBD" => match style {
            "short" | "narrow" => "BBD",
            _ => "Barbadian Dollar",
        ...
        "SLL" => match style {
            "short" | "narrow" => "SLL",
            _ => "Sierra Leonean Leone (1964\u{2013}2022)",
        },
        "SOS" => match style {
            "short" | "narrow" => "SOS",
            _ => "Somali Shilling",
        ...
        "VED" => match style {
            "short" | "narrow" => "VED",
            _ => "Venezuelan Bolivar Digital",
        },
        "VES" => match style {
            "short" | "narrow" => "VES",
            _ => "Venezuelan Bolivar",
        },
        "VUV" => match style {
            "short" | "narrow" => "VUV",
            _ => "Vanuatu Vatu",
        ...
        "XOF" => match style {
            "short" | "narrow" => "F\u{202F}CFA",
            _ => "West African CFA Franc",
        },
        "XPF" => match style {
            "short" | "narrow" => "CFPF",
            _ => "CFP Franc",
            ...
            move |interp, _this, args| {
                if interp.new_target.is_none() {
                    return Completion::Throw(
                        interp.create_type_error("Constructor Intl.DisplayNames requires 'new'"),
                    );
                }
