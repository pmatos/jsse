/*---
description: >
  Iterator.prototype.map creates its mapper validation error before closing
  the underlying iterator, so return() cannot change the error's prototype by
  replacing the global TypeError constructor.
