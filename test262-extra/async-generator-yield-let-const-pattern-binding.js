/*---
description: >
  A let/const declaration destructuring the result of a plain `yield` in an
  async generator initializes the bound names instead of throwing a TDZ
  ReferenceError.
